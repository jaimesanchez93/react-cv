    ...
    <Container>
      <Wrapper justify="space-between" align="flex-start">
        ...
        <AboutMeSection direction="column" align="flex-end">
          <Title size="38px" weight="700" margin="10px 0 20px 0">
            About Me
          </Title>
          <Text
            ...
            margin="20px 0"
          >
            I am a software engineer who loves his job and has a passion for
            technology and software, especially web and mobile development.
            Since I was a little kid, I have been learning and playing with
            technology and software. I am an innovating and constant person.
            Moreover, I am a sport and music fan, especially American sports and
            electronic music. I am an outgoing person who likes to converse with
