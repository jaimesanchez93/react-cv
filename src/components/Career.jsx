...
const Career = () => {
  ...
  const careerList = [
    ...
    },
    {
      ...
      description:
        "I worked at Criptored, a project from UPM university, for 7 months as a web developer/UX developer (HTML + CSS)",
    },
    {
      id: 3,
      name: "The Musical Pi",
    ...
    },
    {
      ...
      description:
        "I am involucrated in different projects formed by multiple teams (engineer, product and UX). We are using the Django/Angular stack, and Jenkins for the CI/CD process",
    },
    {
      id: 7,
      name: "Nware",
      ...
      time: "Jun 2020 - Now",
      description:
        "I am the main frontend developer, where I am developing several projects with Angular and React Native. Also I am working side by side with the backend and streaming teams, to integrate all the features with the frontend apps, besides working with the product team to manage the roadmap.",
  ...
  useEffect(() => {
    const tops = [];
    if (!responsive) {
      careerList.forEach((element, index) => {
        let { offsetTop } = document.getElementById(`career-${element.id}`);
        if (element.id % 2 === 0) {
          offsetTop += 50;
        } else if (index > 0) {
          offsetTop += 100;
