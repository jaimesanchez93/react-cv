            ...
            <Content justify="space-between" align="flex-start" margin="28px 0">
               <Column className="technologies-column" direction="column" margin="0 24px 0 0">
                  <SkillItem direction="column" align="flex-start" margin="0 0 24px 0">
                     <Text family={fonts.Montserrat} size="20px" weight="700">Frontend</Text>
                     <TechItem percentage="85" title="Frontend" technologies={frontendList}></TechItem>
                  </SkillItem>
                  <SkillItem direction="column" align="flex-start" margin="24px 0">
                     <Text family={fonts.Montserrat} size="20px" weight="700">Backend</Text>
                     <TechItem percentage="70" technologies={backendList}></TechItem>
                  </SkillItem>
                  <SkillItem direction="column" align="flex-start" margin="24px 0">
                     <Text family={fonts.Montserrat} size="20px" weight="700">Misc</Text>
                     <TechItem percentage="60" technologies={miscList}></TechItem>
                  </SkillItem>
               </Column>
               <Column className="column" direction="column" margin="0 0 0 24px">
                  <SkillItem direction="column" align="flex-start">
                     <Text family={fonts.Montserrat} size="20px" weight="700">Languages</Text>
                     <LanguageItem percentage="70" language="English" level="B2" title="TOEIC Listening & Reading"></LanguageItem>
                  </SkillItem>
                  <SkillItem direction="column" align="flex-start">
                     <LanguageItem percentage="100" language="Spanish" level="Native"></LanguageItem>
                  </SkillItem>
               </Column>
